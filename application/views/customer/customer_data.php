...
<section class="content">
	<div class="box">
		<div class="box-header">
			<h3 class="float-left"> Data Customer</h3>
			<div class="float-sm-right">
				<a href="<?=site_url('customer/add')?>" class="btn btn-primary btn-flat"><i class="fas fa-edit"></i>Create
				</a> 
			</div>
		</div>
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center" width="160px">
							...
							<a href="#modalDelete" data-toggle="modal"  onclick="$('#modalDelete #formDelete').attr('Action', '<?=site_url('customer/del/'.$data->customer_id)?>')" class="btn btn-danger btn-xs">
								<i class="fa fa-trash"></i>Delete
							</a>
							</form>
						</td>
